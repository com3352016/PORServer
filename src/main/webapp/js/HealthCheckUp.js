...
//	http://서버ip or dns/경로/DocumentReference?<query>
//
//		reference는 subject/subject.identifier 가 require니까 이거 구현하고
//		manifest는 subject/subject.identifier, status
//		reference에도 아마 status 필요하겠지?
...
//	});
    ...
    function onDeviceReady() {
    	db = window.openDatabase("chkup", "1.0", "CheckUp DB", 1000000);
    }
    $('#documentsearchButton').click(function(){
        var rootURL = $("#selSearchServer").val();
        var name = $("#subjectName").val();
        var url = rootURL+"DocumentReference?subject.given="+name;
